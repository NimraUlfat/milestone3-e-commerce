...
<section className='py-2 bg-[#ffe4e6] text-white text-right px-10'>
        <p className='text-sm'><strong className="mx-3">Email:</strong>FashionStore@gmail.com<strong className="mx-3">Contact
      ...
      <div className='flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            className='lg:flex lg:gap-x-10 lg:absolute lg:left-1/2 lg:-translate-x-1/2 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
            <li className='mb-6 hidden max-lg:block'>
              <a href="javascript:void(0)"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" className='w-36' />
              </a>
            </li>
            <Link href={"/"}>
            <li className='max-lg:border-b max-lg:py-3 hover:text-[#007bff] text-[15px] text-[#007bff] text-black block font-bold'>Home</li></Link>
      
          
            <Link href={"/about"}>
            <li className='max-lg:border-b max-lg:py-3 hover:text-[#007bff] text-[15px] text-black block font-bold'>About</li></Link>
              <Link href={"/contact"}>
            <li className='max-lg:border-b max-lg:py-3 hover:text-[#007bff]  text-gray-600 font-bold text-[15px] text-black block'>Contact</li></Link>
            <Link href={"/products"}>
            <li className='max-lg:border-b max-lg:py-3 hover:text-[#007bff]  text-gray-600 font-bold text-[15px] text-black block'>
            Products</li></Link>
